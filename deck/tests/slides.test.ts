...
describe('slide narrative', () => {
  ...
  test('angka proposal dan fallback chain tidak berubah', () => {
    ...
    for (const required of ['14,73 juta ton','Rp213â€“551 triliun','7,29%','Rp960 miliar/tahun','Rp48 miliar/tahun','Rp480 juta/tahun','Rp1.000','forecasts.source','lstm_gemini','lstm_only','heuristic']) {
