...
**Prompt siap tempel:** [`prompts/`](prompts/) — satu berkas per agent (A–G), salin seluruh isinya ke sesi baru. Urutan dan dependensi ada di [`prompts/README.md`](prompts/README.md)
